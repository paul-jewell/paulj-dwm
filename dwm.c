...
struct Monitor {
  ...
  int gappih;           /* horizontal gaps between windows */
  int gappiv;           /* vertical gaps between windows */
...
/* Load autostart programs - defined in config.h */
...
/* execute commands from the autostart array */
static void
autostart_exec()
{
  const char *const *p;
...
setup(void)
{
   ...
   spawn("feh --bg-fill ~/backgrounds/mountains-1412683.jpg &");
	/* init screen */
